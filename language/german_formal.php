...
'coord'                        => 'Koordinaten',
'coord_instr'                => '<ul><li>Geben Sie die Koordinaten als Dezimalzahlen ein.</li><li>Südliche Breitengrade und Westliche Längengrade werden als negative Werte eingegeben.</li></ul>',
...
'group'                        => 'Gruppe',
'have_new_submission'        => 'Sie haben eine neue Standort-Einsendung in der Warteschlange.',
...
'radius'                    => 'Radius',
'reset'                        => 'Zurücksetzen',
'speedlimit_exceeded'        => 'Sie können nur alle ' . $_CONF['speedlimit'] . ' Sekunden einen Suchvorgang durchführen.',
'title'                        => 'Titel',
'url'                        => 'URL',
'version'                    => 'Version',
...
'db_save_error'                => 'Standort-ID bereits vorhanden! Ihr Eintrag konnte leider nicht gespeichert werden.',
'confirm_delitem'            => 'Sind Sie sicher. dass Sie diesen Standort löschen wollen?',
'get_directions'            => 'Routen-Planer',
'start_addr'                => 'Start-Adresse',
'or_address'                => 'oder Adresse',
'select_origin'                => 'Wählen Sie einen Startpunkt oder geben Sie eine Adresse ein.',
'menu_hlp'                    => array(
...
$PLG_locator_MESSAGE1 = 'Ihr Standort wurde erfolgreich gespeichert und zur Überprüfung weitergeleitet.';
$PLG_locator_MESSAGE2 = 'Ihr Standort wurde erfolgreich gespeichert';
...
$PLG_locator_MESSAGE99 = 'Ein Datenbankfehler ist aufgetreten. Überprüfen Sie die Datei "error.log" für Details.';
